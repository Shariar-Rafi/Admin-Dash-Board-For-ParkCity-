            ...
            <div className="flex  justify-start items-center">
              <div className="hidden lg:block lg:pl-2">
                ...
                <div className="relative mt-1 lg:w-80">
                  <div className="absolute inset-y-0 left-0 top-1/2 translate-y-[-35%] ml-2 items-center cursor-pointer">
                    <IoSearch className='' />
                  </div>
                  <input type="text" name="email" id="topbar-search"
                    className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 
                block w-full pl-9 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                    placeholder="Search" />
                </div>
              </div>
            </div>
